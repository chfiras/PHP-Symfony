...
class CoreController extends Controller
{
  ...
  {
    $fiches = $this->getDoctrine()->getManager()->getRepository('OCPlatformBundle:Advert')->findAll();
    $factures = $this->getDoctrine()->getManager()->getRepository('OCPlatformBundle:Facturation')->findAll();
